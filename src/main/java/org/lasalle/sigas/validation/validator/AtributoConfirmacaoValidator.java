package org.lasalle.sigas.validation.validator;
...
public class AtributoConfirmacaoValidator implements ConstraintValidator<AtributoConfirmacao, Object>{
	...
	public boolean isValid(Object object, ConstraintValidatorContext context) {
		...
		try {
			...
			valido = ambosSaoNulls(valorAtributo, valorAtributoConfirmacao) || ambosSaoIguais(valorAtributo, valorAtributoConfirmacao);
	...
	private boolean ambosSaoNulls(Object valorAtributo, Object valorAtributoConfirmacao) {
